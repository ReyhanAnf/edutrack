...
export default function Edit({ auth, assignment, subjects }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        subject_id: assignment.data.subject_id.toString(),
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('assignments.update', assignment.data.id));
    };
        ...
        >
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div className="p-8">
                        <div className="mb-8">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Edit Tugas</h2>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui informasi tugas Anda</p>
                        </div>
